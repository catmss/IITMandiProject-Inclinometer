...
// }
    ...
    //delt_t = millis() - count_mpu;
   // if (delt_t > delay_time) {
 ...
 if (abs(present_time1-endmillis)>delay_time){
  ...
  // Roll is angle  Serial.println(energy);between sensor y-axis and Earth ground plane, y-axis up is positive roll.
  // These arise from the definition of the homogeneous rotation matrix constructed from quaternions.
  // Tait-Bryan angles as well as Euler angles are non-commutative; that is, the get the correct orientation the rotations must be
  // applied in the Serial.println(energy); correct order which for this configuration is yaw, pitch, and then roll.
...
**/
    ...
    Serial.println(-1.0f*pitch,2);
    /*
Serial.println(ax);
Serial.println(ay);
Serial.println(az);
    double angle = atan(ay/(sqrt(ax*ax + az*az)));
